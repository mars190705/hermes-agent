...
def test_foreground_command_uses_registered_task_cwd_for_existing_environment(monkeypatch):
    ...
    monkeypatch.setattr(terminal_tool, "_get_env_config", lambda *a, **kw: _minimal_terminal_config())
    monkeypatch.setattr(
        terminal_tool,
        "_check_all_guards",
...
def test_background_command_prefers_recorded_session_cwd_over_init_time_cwd(monkeypatch):
    ...
    monkeypatch.setattr(terminal_tool, "_get_env_config", lambda *a, **kw: _minimal_terminal_config(cwd="/workspace/init"))
